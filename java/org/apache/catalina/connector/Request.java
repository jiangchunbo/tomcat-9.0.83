 ...
 * <p>
 * 把 [郊狼] 请求包装起来的对象。因为 [郊狼] 请求能力太强大了，不应该给用户暴露那么多能力。
 *
...
public class Request implements HttpServletRequest {
     ...
     * @throws IllegalStateException if <code>getReader()</code> has already been called for this request
     * @throws IOException           if an input/output error occurs
     */
    @Override
     ...
     * @throws IllegalStateException if <code>getInputStream()</code> has already been called for this request
     * @throws IOException           if an input/output error occurs
     */
    @Override
